...
# this trial uses a different reward
# reward consider: COM, Forward velocity, position (not too low)
...
memory = SequentialMemory(limit=1000000, window_length=1)  # not same as default
...
agent.compile(Adam(lr=.001, clipnorm=1.), metrics=['mae'])  #critic learning rate?
